/*
 * JaxRSServiceProjectPackagerTest.java
 *   
 ...
 * @author ffischer
 */
public class JaxRSServiceProjectPackagerTest {
    ...
    public void testProcess() {
        ...
        JaxRSServiceProjectPackager instance = new JaxRSServiceProjectPackager();
        instance.process();
    }
    ...
    public void testEvaluateFNameServiceProject() {
        ...
        params.put("bo", JaxRSServiceProjectPackager.createTestObject());
